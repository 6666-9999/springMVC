	...
	$(function() {
		$("#dis").change(
				function() {
					...
					$.getJSON("street?did=" + did, function(sb) {
						var option;
...
<body>
	...
	<DIV id="regLogin" class="wrap">
		<DIV class="dialog">
			...
			<DIV class="box">
				<FORM id='add_action' method='post' action='add.action'>
					<DIV class="infos">
						<TABLE class="field">
							<TBODY>
								<TR>
									...
									<TD><INPUT type="hidden" name="id" value=""> <INPUT
										id='add_title' class="text" type="text" name="title" value="">
									</TD>
								</TR>
								<TR>
